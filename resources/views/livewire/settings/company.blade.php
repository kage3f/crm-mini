            ...
            <div class="card">
                ...
                <form wire:submit.prevent="save" class="p-6 space-y-5">
                    <div class="max-w-md space-y-4">
                        ...
                        <div>
                            <label class="label opacity-50">Slug (ID da Empresa)</label>
                            <input type="text" class="input bg-slate-50 cursor-not-allowed" value="{{ auth()->user()->tenant_id }}" disabled>
                            <p class="text-[10px] text-slate-400 mt-1 uppercase tracking-tighter">O ID da empresa não pode ser alterado.</p>
                        </div>
                    </div>
